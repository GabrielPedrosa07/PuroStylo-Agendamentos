...
<head>
	...
	<style>
        :root {
            --cor-primaria: <?php echo $cor_sistema ?>;
            --cor-secundaria: <?php echo $cor_icone ?>;
        }
        ...
        /* Adjust specific admin panel elements */
        .cbp-spmenu-vertical {
		...
		<div class="modal-content">
			...
			<form method="post" id="form-config">
				<div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="myConfigTabs" style="margin-bottom: 20px;">
                        <li class="active"><a href="#tab-geral" data-toggle="tab">Geral</a></li>
                        <li><a href="#tab-config" data-toggle="tab">Configurações</a></li>
                        <li><a href="#tab-textos" data-toggle="tab">Textos</a></li>
                        <li><a href="#tab-imagens" data-toggle="tab">Imagens</a></li>
                    </ul>
                    ...
                    <div class="tab-content" style="padding-bottom: 10px;">
                        ...
                        <div class="tab-pane fade in active" id="tab-geral">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label id="lbl-nome">Nome Barbearia</label>
                                        <input type="text" class="form-control" id="nome_sistema" name="nome_sistema" placeholder="Nome do Estabelecimento" value="<?php echo $nome_sistema ?>" required>    
                                    </div> 	
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label id="lbl-email">Email Barbearia</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label id="lbl-whatsapp">Whatsapp Barbearia</label>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label id="lbl-fixo">Tel Fixo Barbearia</label>
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label id="lbl-endereco">Endereço Barbearia</label>
                        ...
                        <div class="tab-pane fade" id="tab-config">
                             <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="tipo_sistema" id="tipo_sistema" onchange="mudarLabels()">
                                            <option value="Barbearia" <?php if(@$tipo_sistema == 'Barbearia'){?> selected <?php } ?> >Barbearia</option>
                                            <option value="Salão de Beleza" <?php if(@$tipo_sistema == 'Salão de Beleza'){?> selected <?php } ?> >Salão de Beleza</option>
                                        </select>   
                                    </div> 	
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Mensagem Agendamento</label>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Mapa Site <small>(Url incorporada)</small></label>
                             ...
                             <div class="row">
                                <div class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="color" class="form-control" id="cor_sistema" name="cor_sistema" value="<?php echo @$cor_sistema ?>">  
                                    </div> 	
                                </div>
                                <div class="col-md-4">
                                     <div class="form-group">
                                        <label>Cor dos Ícones</label>
                                        <input type="color" class="form-control" id="cor_icone" name="cor_icone" value="<?php echo @$cor_icone ?>">  
                                    </div> 	
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="tab-textos">
                            <div class="row">
                                <div class="col-md-12">
                                <div class="form-group">
                                        <label>Texto Rodapé Site <small>(255) Caracteres</small></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <div class="form-group">
                                        <label>Texto Sobre (Site) <small>(600) Caracteres</small></label>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                <div class="form-group">
                                        <label>Texto Cartão Fidelidade</label>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        function mudarLabels() {
            var tipo = document.getElementById('tipo_sistema').value;
            
            if (tipo == 'Salão de Beleza') {
                document.getElementById('lbl-nome').innerText = 'Nome Salão de Beleza';
                document.getElementById('lbl-email').innerText = 'Email Salão de Beleza';
                document.getElementById('lbl-whatsapp').innerText = 'Whatsapp Salão de Beleza';
                document.getElementById('lbl-fixo').innerText = 'Tel Fixo Salão de Beleza';
                document.getElementById('lbl-endereco').innerText = 'Endereço Salão de Beleza';
            } else {
                document.getElementById('lbl-nome').innerText = 'Nome Barbearia';
                document.getElementById('lbl-email').innerText = 'Email Barbearia';
                document.getElementById('lbl-whatsapp').innerText = 'Whatsapp Barbearia';
                document.getElementById('lbl-fixo').innerText = 'Tel Fixo Barbearia';
                document.getElementById('lbl-endereco').innerText = 'Endereço Barbearia';
            }
        }
