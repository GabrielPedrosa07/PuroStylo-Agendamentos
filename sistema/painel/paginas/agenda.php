...
<head>
    <style>
        /* ===== NOVO VISUAL PARA HORÁRIOS (BOTÕES EM GRADE) ===== */
        #listar-horarios {
            display: grid;
            grid-template-columns: repeat(auto-fill, minmax(85px, 1fr)); /* Cria uma grade responsiva */
        ...
        /* Removemos o padding do .form-check para o alinhamento da grade funcionar */
        ...
        /* Cor da borda para status Agendado */
        .status-agendado {
            border-left-color: #0d6efd; 
        }
        /* Cor da borda para status Concluído */
        .status-concluido {
...
function inserir(){
    ...
    var funcionarioId = "<?php echo $_SESSION['id']; ?>";
...
function fecharServico(dados) { // Recebe um único objeto 'dados'
    ...
    function listar(){
        var funcionario = "<?php echo $_SESSION['id']; ?>";
