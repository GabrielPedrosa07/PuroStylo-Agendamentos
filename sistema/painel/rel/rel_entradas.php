...
<body>
        ...
        <?php if (!empty($entradas)): ?>
            <table class="table relatorio-tabela">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td><?php echo htmlspecialchars($entrada['descricao']); ?></td>
                        <td><?php echo htmlspecialchars($entrada['tipo']); ?></td>
                        <td>R$ <?php echo $valorF; ?></td>
                        <td><?php echo $data_pgtoF; ?></td>
                        <td><?php echo htmlspecialchars($entrada['nome_usuario_baixa'] ?? '-'); ?></td>
    ...
    <div class="resumo-relatorio">
        <span>ITEMS: <?php echo count($entradas); ?></span>
        <span class="text-success">TOTAL: R$ <?php echo number_format($total_entradas_valor, 2, ',', '.'); ?></span>
    </div>
    <?php endif; ?>
