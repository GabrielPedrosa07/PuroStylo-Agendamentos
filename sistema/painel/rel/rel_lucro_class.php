...
// Se o tipo de relatório não for PDF, podemos gerar o HTML e parar (útil para depuração)
if ($tipo_rel != 'PDF') {
    include 'rel_lucro.php';
    exit();
}
...
// As variáveis $dataInicial e $dataFinal já estão disponíveis para o arquivo incluído
include 'rel_lucro.php';
